...
import com.frontiertechnologypartners.beganretail.widgets.MMPhoneChecker.exception.InvalidMyanmarTelecomNameException;
...
enum MyanmarTelecomsOperator {
    ...
    MPT("MPT", "^(09|\\+?959)(5\\d{0,6}|4\\d{0,8}|2\\d{0,8}|3\\d{0,8}|6\\d{0,6}|8\\d{0,8}|7(0|1|2|3)\\d{6}|9(0|1|9)\\d{0,6}|2[0-4]\\d{0,5}|5[0-6]\\d{0,5}|8[13-7]\\d{0,5}|3[0-369]\\d{0,6}|34\\d{0,7}|4[1379]\\d{0,6}|73\\d{0,6}|91\\d{0,6}|25\\d{0,7}|26[0-5]\\d{0,6}|40[0-4]\\d{0,6}|42\\d{0,7}|45\\d{0,7}|89[6789]\\d{0,6}|)$");
